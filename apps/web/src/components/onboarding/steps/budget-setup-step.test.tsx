...
const mockUseOnboardingStore = useOnboardingStore as unknown as jest.MockedFunction<typeof useOnboardingStore>;
const mockUseAccountBookStore = useAccountBookStore as unknown as jest.MockedFunction<
  typeof useAccountBookStore
>;
const mockBudgetApiService = BudgetApiService as unknown as jest.Mocked<typeof BudgetApiService>;
const mockFamilyApiService = FamilyApiService as unknown as jest.Mocked<typeof FamilyApiService>;
